...
public class EACTags
{
    ...
    public static final int ISSUER_IDENTIFICATION_NUMBER 					= 0x02;
    ...
    public static final int PRIMARY_ACCOUNT_NUMBER             				= 0x5A;
    ...
    public static final int CARDHOLDER_NAME             					= 0x20;
    ...
    public static final int APPLICATION_EXPIRATION_DATE             		= 0x24;
    public static final int APPLICATION_EFFECTIVE_DATE             			= 0x25;
    ...
    public static final int INTERCHANGE_PROFILE             				= 0x29;
    ...
    public static final int STATIC_INTERNAL_AUTHENTIFICATION_ONE_STEP 		= 0x37;
    ...
    public static final int CERTIFICATE_HOLDER_AUTHORIZATION             	= 0x5F4C;
    ...
    public static final int CARDHOLDER_CERTIFICATE           				= 0x21;
    ...
    public static final int CARDHOLDER_PUBLIC_KEY_TEMPLATE             		= 0x49;
    public static final int CERTIFICATE_HOLDER_AUTHORIZATION_TEMPLATE		= 0x4C;
    public static final int CERTIFICATE_CONTENT_TEMPLATE             		= 0x4E;
    public static final int CERTIFICATE_BODY			             		= 0x4E;
